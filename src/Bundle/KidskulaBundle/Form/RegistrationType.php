    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
		...
		$builder
			...
			->add('email', 'repeated', array(
				...
				'required' => true,
				'first_options'  => array('label' => 'Email','attr'=>array('placeholder'=>'Parent\'s Email Address','class' => 'form-control input-lg')),
