...
class ClubController extends Controller {
    ...
    public function indexAction() {
       ...
       //***************notification fetching end*************************
        ...
        return $this->render('BundleParentBundle:Club:clubs.html.twig', array('entity' => $allclubs,
                                                                                'membership'=>$array,
    ...
    public function clublistAction() {
       ...
       // \Doctrine\Common\Util\Debug::dump($membership);exit;
        return $this->render('BundleParentBundle:Club:club.html.twig', array('entity' => $allclubs,'membership'=>$array,'myclubentity'=>$membership));
    ...
    public function clubdetailsAction($id) {
        ...
        return $this->render('BundleParentBundle:Club:club_details.html.twig',array('allclubDetails'=>$allclubDetails,
    ...
    public function createarticleAction(Request $request) {
        ...
        $form = $this->createForm(new ClubArticleType($em));
        $allclubDetails = $em->getRepository('BundleAdminBundle:KidsKulaClub')->findOneBy(array('status' => 1,'id'=>$id));
        return $this->render('BundleParentBundle:Club:club_details.html.twig',array('allclubDetails'=>$allclubDetails,'form'=>$form->createView()));
    }
    ...
    public function articlelistingAction($id,$status,$articleid=0) {
       ...
       //*********************FOR 'my-articles' ********************
	    ...
	    return $this->render('BundleParentBundle:Club:article.html.twig',array('allclubDetails'=>$allclubDetails,'form'=>$form->createView(),'clubArticles'=>$clubArticles,'articleowner'=>$articleowner,'title'=>$title,'clubid'=>$id));
    ...
    public function getdiscussionAction(Request $request, $eventId=0, $parentId=0) {
        ...
        return $this->render('BundleParentBundle:Club:comment.html.twig', $data);
    }
  ...
  public function articlelikeAction(Request $request) {
    ...
    public function studentclublogAction(Request $request) {
        ...
        return $this->render('BundleParentBundle:Logtracker:tracker.html.twig');
      }
}
