 ...
 *
 * @ORM\Table(name="kidskula_avatar")
 * @ORM\Entity
 * @UniqueEntity(fields="avatarTitle", message="Sorry, this name is already occupied.")
 */
class KidsKulaStudentAvatar {
     ...
     * @var string
     *
     * @ORM\Column(name="avatarTitle", type="string", length=255, nullable=true)
     */
    private $avatarTitle;
    ...
    public function __construct() {
        //$this->kidskulaUsersUser = new \Doctrine\Common\Avatar\ArrayCollection();
        $this->status = 1;
    }
    ...
    public function setAvatarTitle($avatarTitle) {
