...
class Contactus {
     ...
     * @var string
     *
     * @ORM\Column(name="registered_as", type="string", length=255, nullable=true)
     */
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="question_regarding", referencedColumnName="id", nullable=true)
     * })
     */
	...
	public function setSendby(\Bundle\AdminBundle\Entity\KidsKulaUsers $sendby) {
	 ...
	 public function setQuestionregarding(\Bundle\AdminBundle\Entity\KidsKulaContactCategory $questionregarding) {
        $this->questionregarding = $questionregarding;
    }
	
	public function setCategoryid(\Bundle\AdminBundle\Entity\KidsKulaContactCategory $categoryid ) {
