...
class KidsKulaUsers extends BaseUser {
    ...
    /**
     * @var \Bundle\AdminBundle\Entity\KidsKulaCountry
     *
     * @ORM\OneToOne(targetEntity="Bundle\AdminBundle\Entity\KidsKulaCountry")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="country", referencedColumnName="id", unique=true)
     * })
     */
    private $country;
     ...
     * @var string
     *
     * @ORM\Column(name="myavatar", type="string", length=255, nullable=true,unique=true)
     */
    private $myavatar;
