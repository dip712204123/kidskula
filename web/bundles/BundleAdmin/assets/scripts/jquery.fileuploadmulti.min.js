...
(function(b) {
    ...
    b.fn.uploadFile = function(t) {
        ...
        function p(v, u) {
            ...
            this.inputbox = b("<div style='margin: 0 10px 5px;'><input type='text' name='multiple_image_name[]' placeholder='Enter Title'></div>").appendTo(this.statusbar);
            this.inputbox = b("<div style='margin: 0 10px 5px;'><input type='text' name='multiple_point[]' placeholder='Enter Point'></div>").appendTo(this.statusbar);
