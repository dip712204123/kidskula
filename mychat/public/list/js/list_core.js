						...
						if (i == "buddylist") {
							...
							a.each(e, function (l, f) {
								if (ac_max_results == 0 || z < ac_max_results) {
									...
									c[f.s] += '<div id="arrowchat_userlist_pub_' + f.id + '" class="col-md-4 friendlist arrowchat_userlist_pub"><img class="img-circle collection-green-border img-responsiv arrowchat_userlist_pub_avatar ' + d + '" src="' + f.a + '" width="100" height="100" /></div>';
