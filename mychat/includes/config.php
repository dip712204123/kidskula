<?php 
	...
	*/
	...
	define('DB_USERNAME','kidskula_wgtkids'); 
	define('DB_PASSWORD','yy3ze67~c*hS'); 
	define('DB_NAME','kidskula_wgtkidskula');	
	...
	*/
	 ...
	 */
	define('DB_USERTABLE','kidskula_users'); 
	define('DB_USERTABLE_NAME','username'); 
	define('DB_USERTABLE_USERID','id'); 
	define('DB_USERTABLE_AVATAR','profile_cropped_image'); 
	
	define('DB_FRIENDSTABLE','kidskula_friend_request'); 
	define('DB_FRIENDSTABLE_USERID', 'sender_id'); 
	define('DB_FRIENDSTABLE_FRIENDID', 'receiver_id'); 
