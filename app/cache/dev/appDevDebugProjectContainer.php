...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'anywordyouwant.twig.extension.mytwigextension' => 'getAnywordyouwant_Twig_Extension_MytwigextensionService',
            ...
            'bundle_mailservice' => 'getBundleMailserviceService',
            'bundle_notifyservice' => 'getBundleNotifyserviceService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp/htdocs/kidskula/app/cache/dev/annotations', true);
    }

    /**
     * Gets the 'anywordyouwant.twig.extension.mytwigextension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Bundle\AdminBundle\Extension\MyTwigExtension A Bundle\AdminBundle\Extension\MyTwigExtension instance.
     */
    protected function getAnywordyouwant_Twig_Extension_MytwigextensionService()
    {
        return $this->services['anywordyouwant.twig.extension.mytwigextension'] = new \Bundle\AdminBundle\Extension\MyTwigExtension($this->get('doctrine.orm.default_entity_manager'), $this->get('router'), $this);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/xampp/htdocs/kidskula/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    /**
     * Gets the 'bundle_mailservice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Bundle\AdminBundle\Manager\MailerService A Bundle\AdminBundle\Manager\MailerService instance.
     */
    protected function getBundleMailserviceService()
    {
        return $this->services['bundle_mailservice'] = new \Bundle\AdminBundle\Manager\MailerService($this->get('doctrine.orm.default_entity_manager'), $this, $this->get('router'), $this->get('templating'), $this->get('twig'), array('template' => array('confirmation' => 'BundleKidskulaBundle:Mailing:email.txt.twig', 'resetting' => 'VetPublicBundle:Resetting:email.txt.twig', 'new' => 'VetPublicBundle:Email:new.email.twig')));
    }

    /**
     * Gets the 'bundle_notifyservice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Bundle\AdminBundle\Manager\NotificationManager A Bundle\AdminBundle\Manager\NotificationManager instance.
     */
    protected function getBundleNotifyserviceService()
    {
        return $this->services['bundle_notifyservice'] = new \Bundle\AdminBundle\Manager\NotificationManager($this->get('doctrine.orm.default_entity_manager'), $this, $this->get('router'), $this->get('templating'), $this->get('twig'));
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/xampp/htdocs/kidskula/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'kidskula', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_a3ca28118282a2d2b4d8ca38f360bdf75619781c223d21fa6324def75155479f');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_a3ca28118282a2d2b4d8ca38f360bdf75619781c223d21fa6324def75155479f');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_a3ca28118282a2d2b4d8ca38f360bdf75619781c223d21fa6324def75155479f');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\xampp\\htdocs\\kidskula\\src\\Bundle\\AdminBundle\\Entity')), 'Bundle\\AdminBundle\\Entity');
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array('C:\\xampp\\htdocs\\kidskula\\vendor\\friendsofsymfony\\user-bundle\\Resources\\config\\doctrine\\model' => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('BundleAdminBundle' => 'Bundle\\AdminBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('C:/xampp/htdocs/kidskula/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/xampp/htdocs/kidskula/app/Resources');
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Bundle\\AdminBundle\\Entity\\KidsKulaUsers');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Bundle\\AdminBundle\\Entity\\KidsKulaUsers');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Bundle\\AdminBundle\\Entity\\KidsKulaUsers');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Bundle\\AdminBundle\\Entity\\KidsKulaUsers');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Bundle\\AdminBundle\\Entity\\KidsKulaUsers');
    }
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(array('defaultPaginationTemplate' => 'BundleAdminBundle:Pagination:sliding.html.twig', 'defaultSortableTemplate' => 'BundleAdminBundle:Pagination:sortable_link.html.twig', 'defaultFiltrationTemplate' => 'KnpPaginatorBundle:Pagination:filtration.html.twig', 'defaultPageRange' => 10));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/kidskula/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/xampp/htdocs/kidskula/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Bundle\\AdminBundle\\Entity\\KidsKulaUsers' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('/students');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('/student/find-friends');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('/student/search_friends');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('/student/contact');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('/student/login');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('/student/forgotpassword');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('/reset-password');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('/student/registration');

        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('/student/auth_registration/');

        $r = new \Symfony\Component\HttpFoundation\RequestMatcher('/student_activation');

        $s = new \Symfony\Component\HttpFoundation\RequestMatcher('/parents');

        $t = new \Symfony\Component\HttpFoundation\RequestMatcher('/parent/registration');

        $u = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin');

        $v = new \Symfony\Component\HttpFoundation\RequestMatcher('^/student');

        $w = new \Symfony\Component\HttpFoundation\RequestMatcher('^/parent');
        ...
        $x->add($k, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $x->add($l, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $x->add($m, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $x->add($n, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $x->add($o, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $x->add($p, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $x->add($q, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $x->add($r, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $x->add($s, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $x->add($t, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $x->add($u, array(0 => 'ROLE_ADMIN'), NULL);
        $x->add($v, array(0 => 'ROLE_STUDENT'), NULL);
        $x->add($w, array(0 => 'ROLE_PARENT'), NULL);

        $y = new \Symfony\Component\Security\Http\HttpUtils($e, $e);

        $z = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'ThisTokenIsNotSoSecretChangeIt', 'main', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $aa = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $y, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($y, '/student/login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        $aa->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $aa->addHandler($z);

        $ba = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($y, array('login_path' => '/student/login', 'always_use_default_target_path' => false, 'default_target_path' => '/student/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $ba->setProviderKey('main');

        $ca = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, $this->get('security.authentication.session_strategy'), $y, 'main', $ba, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $y, array('login_path' => '/student/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'post_only' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'require_previous_session' => true), $a, $d, $this->get('form.csrf_provider'));
        $ca->setRememberMeServices($z);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($x, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'main', $a, $d), 2 => $aa, 3 => $ca, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $z, $g, $a, $d), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '54cb55700d330', $a), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $x, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $y, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $y, '/student/login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/kidskula/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/xampp/htdocs/kidskula/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/xampp/htdocs/kidskula/app/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/kidskula/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('careers@webgentechnologies.com');
        $a->setPassword('abc@1234');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/xampp/htdocs/kidskula/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('anywordyouwant.twig.extension.mytwigextension'));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/xampp/htdocs/kidskula/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\kidskula\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\xampp\\htdocs\\kidskula\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\xampp\\htdocs\\kidskula\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\xampp\\htdocs\\kidskula\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\xampp\\htdocs\\kidskula\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\xampp\\htdocs\\kidskula\\src\\Bundle\\AdminBundle/Resources/views', 'BundleAdmin');
        $instance->addPath('C:\\xampp\\htdocs\\kidskula\\vendor\\friendsofsymfony\\user-bundle/Resources/views', 'FOSUser');
        $instance->addPath('C:\\xampp\\htdocs\\kidskula\\src\\Bundle\\KidskulaBundle/Resources/views', 'BundleKidskula');
        $instance->addPath('C:\\xampp\\htdocs\\kidskula\\vendor\\knplabs\\knp-paginator-bundle\\Knp\\Bundle\\PaginatorBundle/Resources/views', 'KnpPaginator');
        $instance->addPath('C:\\xampp\\htdocs\\kidskula\\src\\Bundle\\CommonBundle/Resources/views', 'BundleCommon');
        $instance->addPath('C:\\xampp\\htdocs\\kidskula\\src\\Bundle\\ParentBundle/Resources/views', 'BundleParent');
        $instance->addPath('C:\\xampp\\htdocs\\kidskula\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\xampp\\htdocs\\kidskula\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/xampp/htdocs/kidskula/app/Resources/views');
        $instance->addPath('C:\\xampp\\htdocs\\kidskula\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'C:\\xampp\\htdocs\\kidskula\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml', 1 => 'C:\\xampp\\htdocs\\kidskula\\vendor\\friendsofsymfony\\user-bundle\\Resources\\config\\validation.xml'));
        ...
        $instance->addXmlMapping('C:\\xampp\\htdocs\\kidskula\\vendor\\friendsofsymfony\\user-bundle\\DependencyInjection\\Compiler/../../Resources/config/validation/orm.xml');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/kidskula/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/xampp/htdocs/kidskula/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_PARENT', 2 => 'ROLE_STUDENT')));
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/kidskula/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/xampp/htdocs/kidskula/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/kidskula/app/cache/dev',
            'kernel.logs_dir' => 'C:/xampp/htdocs/kidskula/app/logs',
            'kernel.bundles' => array(
                ...
                'BundleAdminBundle' => 'Bundle\\AdminBundle\\BundleAdminBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'BundleKidskulaBundle' => 'Bundle\\KidskulaBundle\\BundleKidskulaBundle',
                'KnpPaginatorBundle' => 'Knp\\Bundle\\PaginatorBundle\\KnpPaginatorBundle',
                'BundleCommonBundle' => 'Bundle\\CommonBundle\\BundleCommonBundle',
                'BundleParentBundle' => 'Bundle\\ParentBundle\\BundleParentBundle',
            ...
            'per_page' => 20,
            'root_path' => '/../../../../web/',
            'upload_image_path' => 'upload/',
            'profile_image_path' => 'profilepicture/',
            'profile_resize_image_path' => 'resizedimages/',
            'profile_crop_image_path' => 'cropedimages/',
            'club_image_path' => 'upload/clubimages',
            'collection_image_path' => '/../web/upload/collections/',
            'collection_crop_image_path' => 'cropedimages/',
            'avatar_image_path' => '/../web/upload/avatar',
            'mailer_transport' => 'gmail',
            'mailer_host' => 'tls://smtp.gmail.com',
            'mailer_user' => 'careers@webgentechnologies.com',
            'mailer_password' => 'abc@1234',
            'from_email' => 'info@kidskula.com',
            ...
            'debug.container.dump' => 'C:/xampp/htdocs/kidskula/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/xampp/htdocs/kidskula/app/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/xampp/htdocs/kidskula/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/xampp/htdocs/kidskula/app/cache/dev/assetic/routing.yml',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'careers@webgentechnologies.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'abc@1234',
            'swiftmailer.mailer.default.transport.smtp.auth_mode' => 'login',
            'swiftmailer.mailer.default.transport.smtp.timeout' => 30,
            'swiftmailer.mailer.default.transport.smtp.source_ip' => NULL,
            'swiftmailer.spool.default.memory.path' => 'C:/xampp/htdocs/kidskula/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/kidskula/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/xampp/htdocs/kidskula/app/../web',
            'assetic.write_to' => 'C:/xampp/htdocs/kidskula/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/kidskula/app/cache/dev/doctrine/orm/Proxies',
            ...
            'fos_user.model.user.class' => 'Bundle\\AdminBundle\\Entity\\KidsKulaUsers',
            ...
            'knp_paginator.template.pagination' => 'BundleAdminBundle:Pagination:sliding.html.twig',
            'knp_paginator.template.filtration' => 'KnpPaginatorBundle:Pagination:filtration.html.twig',
            'knp_paginator.template.sortable' => 'BundleAdminBundle:Pagination:sortable_link.html.twig',
